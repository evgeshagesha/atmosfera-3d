/**
 * Centralized landing copy — edit texts/titles/CTAs here only.
...
window.SITE_CONTENT = {
  ...
  seo: {
    ...
    description:
      "Функциональная оценка, личная сессия и персональный план движения, тренировок и восстановления на 30 дней. Онлайн или очно в Москве.",
  },
  ...
  hero: {
    eyebrow: "ИНДИВИДУАЛЬНАЯ РАБОТА · ОНЛАЙН И МОСКВА",
    titleLine1: "ПЕРСОНАЛЬНАЯ",
    titleLine2: "СТРАТЕГИЯ",
    titleAccent: "ТЕЛА",
    subtitle:
      "Персональный план движения, силы, восстановления и дисциплины на 30 дней — под ваше тело, график и реальную жизнь.",
    body:
      "Я изучу ваш образ жизни, состояние тела, рабочий график, результаты тестирования, питание, сон и уровень нагрузки. После глубокой личной сессии вы получите понятную систему действий на ближайший месяц.",
    primaryCta: "ПОЛУЧИТЬ ПЕРСОНАЛЬНУЮ СТРАТЕГИЮ",
  ...
  benefits: [
    {
      title: "Индивидуально под вас",
      text: "Без шаблонной программы.",
      icon: "person",
    },
    {
      title: "План на 30 дней",
      text: "Понятная последовательность действий.",
      icon: "calendar",
    },
    {
      title: "Личная сессия",
      text: "Разбор тела, режима и целей.",
      icon: "chat",
    },
    {
      title: "Персональный PDF",
      text: "Все рекомендации в одном документе.",
      icon: "doc",
    },
    {
      title: "Поддержка после сессии",
      text: "Семь дней для уточняющих вопросов.",
      icon: "support",
    },
  ],
  ...
  /** Short expert notes for #expert placeholder — facts only, no invented awards */
  expertBrief: [
  ...
  form: {
    ...
    consentHtml:
      'Я согласен на обработку персональных данных и принимаю <a href="https://eg.egoshev.ru/policy" target="_blank" rel="noopener noreferrer">политику конфиденциальности</a>.',
    steps: [
      {
        id: "name",
        question: "Как вас зовут?",
        fields: [{ key: "name", type: "text", label: "Имя", required: true, autocomplete: "name", maxLength: 80 }],
      },
      {
        id: "age_city",
        question: "Сколько вам лет и в каком городе вы живёте?",
        fields: [
          { key: "age", type: "text", label: "Возраст", required: true, inputmode: "numeric", maxLength: 3 },
          { key: "city", type: "text", label: "Город", required: true, autocomplete: "address-level2", maxLength: 80 },
        ],
      },
      {
        id: "occupation",
