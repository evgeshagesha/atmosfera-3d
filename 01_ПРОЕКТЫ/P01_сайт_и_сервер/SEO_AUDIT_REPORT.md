...
| **Статус** | 🟡 Черновик аудита · жду подтверждения Евгения |
| **Связанные** | [SEO_KEYWORD_MAP](./SEO_KEYWORD_MAP.md) · [CONTENT_SEO_GUIDE](./CONTENT_SEO_GUIDE.md) · [SEO_ФУНДАМЕНТ](./SEO_ФУНДАМЕНТ.md) · [СТИЛЬ_СТАТЕЙ_БЛОГА](./СТИЛЬ_СТАТЕЙ_БЛОГА.md) |
...
Перед любой правкой кода / публикацией money pages — подтверди, **что создавать первым** (рекомендация research C):

### Первые 5–7 money pages

1. **`/personalnye-trenirovki-moskva`** — персональные тренировки / приём Москва  
2. **`/mfr-massazh-moskva`** — МФР / массаж-восстановление в системе движения  
3. **`/funkcionalnye-trenirovki-moskva`** — функциональные тренировки  
4. **`/osanka`** — осанка (+ мост к курсу 1 990 ₽)  
5. **`/online-trener`** — онлайн-тренер / сопровождение (+ клуб / база)  
6. **`/mobilnost`** — мобильность  
7. **`/ofp`** — ОФП (опционально в первой волне, если приоритет спортсменов)

Параллельно (не money, но блокеры):
- [ ] Новый title/H1 главной (без PT-primary)
- [ ] Meta `/uslugi` + `/online`
- [ ] IG в sameAs + club JsonLd
- [ ] Я.Бизнес NAP
- [ ] Ручной Wordstat по seeds

**Ответь:** какие из 7 URL в первой волне, и что важнее сейчас — студия / курс / клуб?

---

## 🔗 Навигация

[← SEO_KEYWORD_MAP](./SEO_KEYWORD_MAP.md) · [CONTENT_SEO_GUIDE](./CONTENT_SEO_GUIDE.md) · [SEO_ФУНДАМЕНТ](./SEO_ФУНДАМЕНТ.md) · [СТИЛЬ_СТАТЕЙ_БЛОГА](./СТИЛЬ_СТАТЕЙ_БЛОГА.md) · [ГЛАВНЫЙ_КОНТЕКСТ](../../00_ПУЛЬТ_УПРАВЛЕНИЯ/ГЛАВНЫЙ_КОНТЕКСТ.md)
