...
export const STRATEGY_CONTENT = {
  ...
  hero: {
    ...
    body: "Я изучу ваш образ жизни, состояние тела, рабочий график, результаты тестирования, питание, сон и уровень нагрузки. После глубокой личной сессии вы получите понятную систему действий на ближайший месяц.",
