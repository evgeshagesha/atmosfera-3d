...
const PATHS: Record<StrategyIconName, ReactNode> = {
  ...
  timer: (
    <>
      ...
      <path d="M16.8 5.8l1.4 1.4" />
    </>
  ),
  arm: (
    <>
      <path d="M8 20.5c1.2-3.2 2-5.5 2-7.2 0-1.8-1-3.3-1-4.8 0-1.6 1.2-2.8 2.8-2.8S14.6 6.9 14.6 8.5c0 1.2-.4 2.2-.4 3.5 0 2.4 1.2 4.2 2.4 6.5" />
      <path d="M10 9.2c.8-.6 1.6-.9 2.4-.9" />
    </>
  ),
  eye: (
    <>
  ...
  clipboard: (
    <>
      ...
      <path d="M9 5.2V4.5a1.5 1.5 0 0 1 1.5-1.5h3A1.5 1.5 0 0 1 15 4.5v.7" />
